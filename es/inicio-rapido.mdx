...
<Info>
Necesitas el **slug de tu organización** (te lo entrega tu operador, ej.
`cbpay`). Si tu operador ya te creó la cuenta y te entregó una API key
`pk_...`, salta directo al paso 3.
</Info>
