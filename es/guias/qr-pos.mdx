...
del motor del [link de cobro universal](/es/guias/payins#link-de-cobro-universal-checkout)):
...
Cada merchant nace amarrado a una [verificación KYC/KYB de terceros](/es/guias/kyc)
...
con los rieles existentes: [transferencias](/es/guias/transferencias),
[payouts fiat](/es/guias/payouts) o [retiros crypto](/es/guias/crypto).
...
- El monto se devuelve en el **crypto del cobro**: como el pago se convirtió
  ...
  [swap](/es/guias/swaps) de vuelta si te falta; el error es
  `insufficient_funds`).
...
<AccordionGroup>
<Accordion title="¿Cuánto demora en confirmar el pago en el POS?">
...
<Accordion title="¿Puedo imprimir el QR en papel?">
...
<Accordion title="¿Qué pasa si el cliente paga menos, más, o tarde?">
...
<Accordion title="¿El dinero queda a nombre del restaurant?">
...
<Accordion title="¿Qué comisiones aplican?">
...
<Accordion title="¿Un POS puede consultar el estado directo contra CBPay?">
