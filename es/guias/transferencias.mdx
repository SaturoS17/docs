...
description: "Mueve USDT entre cuentas de tu organización, gratis y al instante"
---

Las transferencias internas mueven saldo entre dos cuentas de la **misma
organización**, de forma atómica en el ledger y **sin comisión**.
...
- Solo entre cuentas **activas** de la misma organización; las cuentas
  internas del sistema no pueden recibir.
...
| 404 | `recipient_not_found` | El email/ID no corresponde a una cuenta de tu organización |
