...
<Steps>
  <Step title="Crea el link de consentimiento">
  ...
  <Step title="El titular abre el link">
  ...
  <Step title="El titular conecta su banco">
  ...
  <Step title="El consentimiento queda otorgado">
  ...
  <Step title="Sigue el consentimiento">
  ...
  <Step title="Revócalo si hace falta">
...
Mira el [catálogo de errores](/es/errores) para la lista completa.
...
<AccordionGroup>
  <Accordion title="¿El titular necesita una cuenta CBPay?">
  ...
  <Accordion title="¿Qué pasa si el titular conecta una cuenta de otra persona?">
  ...
  <Accordion title="¿Puedo revocar un consentimiento ya otorgado?">
  ...
  <Accordion title="¿Cuánto vive el link?">
  ...
  <Accordion title="¿El email es obligatorio?">
  ...
  <Accordion title="¿Qué países cubre?">
  ...
  <Accordion title="¿Qué datos se derivan exactamente?">
