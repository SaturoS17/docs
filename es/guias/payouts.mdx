...
<Card title="Referencia por país" icon="earth-americas" href="/es/guias/payouts-por-pais">
  Chile, Perú, México, Venezuela, Bolivia, Brasil y Paraguay — el
  `beneficiary` exacto, el request completo y la respuesta de cada corredor.
</Card>
