...
<Note>Qscore también incluye el [informe de fraude e identidad](/es/guias/qscore-fraud) y el [Qscore Index público](/es/guias/qscore-index).</Note>
...
El flujo completo (diagrama mermaid, rechazo por ítem, estados, errores y FAQ) está en la [guía de scoring por lotes](/es/guias/qscore-batch).
