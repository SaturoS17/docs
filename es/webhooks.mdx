...
Los webhooks te notifican los eventos de tu cuenta (o de toda tu
organización, si usas una credencial admin) en un callback HTTPS propio.
...
Con credencial de cuenta la suscripción recibe los eventos de **tu cuenta**;
con API key de administrador, los de **todas las cuentas** de la
organización.
