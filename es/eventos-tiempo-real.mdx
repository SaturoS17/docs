...
Usa [webhooks](/es/webhooks) para todo lo que deba sobrevivir a que cierren el
...
[`GET /v1/balances`](/es/guias/analytics)) y, para un admin de organización,
...
regulación en sus propios endpoints y en la [cartola](/es/guias/cartola).
</Warning>
...
|---|---|---|
| 400 | `invalid_event_type` | Usa un tipo del [catálogo de webhooks](/es/webhooks#eventos). |
...
Lista completa en [Errores](/es/errores).

## Preguntas frecuentes

<AccordionGroup>
  <Accordion title="¿Reemplazo los webhooks por el stream?">
  ...
  <Accordion title="¿Puede llegarme el mismo evento dos veces?">
  ...
  <Accordion title="¿Por qué se cierra la conexión a los 30 minutos?">
  ...
  <Accordion title="¿Necesito una suscripción como con los webhooks?">
  ...
  <Accordion title="No llega nada, ni siquiera el heartbeat.">
  ...
  <Accordion title="¿Un admin de organización puede seguir una sola cuenta?">
