...
<CardGroup cols={2}>
  ...
  <Card title="Checkout" icon="cart-shopping" href="/es/guias/payins#link-de-cobro-universal-checkout">
  ...
  <Card title="Tarjetas y suscripciones" icon="credit-card" href="/es/guias/tarjetas">
    ...
    pagos con tarjeta, guarda tarjetas y agenda cobros recurrentes.
  </Card>
