...
<CardGroup cols={2}>
  ...
  <Card title="Transferencias internas" icon="arrows-left-right" href="/es/guias/transferencias">
    Mueve saldo entre cuentas de la misma organización, al instante y sin
    comisión.
  </Card>
...
Además incluye **KYC/screening** de personas y empresas integrado
([guía](/es/guias/kyc)) y **webhooks firmados** para todos los eventos
([guía](/es/webhooks)).

## Cómo funciona

1. Tu operador (la organización) te da acceso: registro con email/contraseña
