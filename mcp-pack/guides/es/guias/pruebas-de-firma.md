...
slug: es/guias/pruebas-de-firma
lang: es
source_url: https://docs.cbpayapp.com/es/guias/pruebas-de-firma
---
...
Firma con una [wallet segregada](https://docs.cbpayapp.com/es/guias/wallets-segregadas) custodiada por
...
para obtener un `X-OTP-Token` (ver [OTP](https://docs.cbpayapp.com/es/seguridad-2fa)).
### Solicita la firma
...
Suscríbete a estos eventos (ver [Webhooks](https://docs.cbpayapp.com/es/webhooks)):
