...
transferencias anunciadas (hoy Chile y Paraguay), la respuesta del anuncio
...
| 422 | `deposit_instructions_unavailable` | `bank_transfer` en un corredor que exige una cuenta de destino registrada (hoy CL, PY) y tu organización todavía no configuró una — contacta a tu operador CBPay |
