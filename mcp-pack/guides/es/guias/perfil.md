...
slug: es/guias/perfil
lang: es
source_url: https://docs.cbpayapp.com/es/guias/perfil
---
...
[Seguridad y 2FA (OTP)](https://docs.cbpayapp.com/es/seguridad-2fa).
```mermaid
flowchart LR
...
`phone`, `country`, `locale`). `locale` sigue editable tras el KYC. Ver [Idioma y locale](https://docs.cbpayapp.com/es/guias/idioma).
Pero con la verificación de identidad (KYC/KYB)
