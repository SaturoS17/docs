...
slug: es/guias/login-social
lang: es
source_url: https://docs.cbpayapp.com/es/guias/login-social
---
...
([seguridad y 2FA](https://docs.cbpayapp.com/es/seguridad-2fa)), el login social respeta ese segundo
