...
在你的组织已为转账通知类收款登记了收款账户的走廊（目前是智利与巴拉圭），
...
| 422 | `deposit_instructions_unavailable` | `bank_transfer` 走廊要求登记收款账户（目前为 CL、PY），而您的组织尚未配置——请联系您的 CBPay 运营方 |
