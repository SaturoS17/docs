...
| `txn_review_status_changed` | 被[交易防火墙](https://docs.cbpayapp.com/zh/guides/transaction-reviews)挂起的操作审核状态发生变化（`in_review` / `info_requested` / `released` / `rejected`）——负载保持中性，绝不携带内部原因 |
