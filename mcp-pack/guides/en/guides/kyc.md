...
| Documents | Category, file, status, validation outcome, score, validation timestamp and rejection reason |
| Liveness | Per role (holder, UBO N): outcome, gate, liveness / antispoofing / face similarity scores |
...
| AML screening | Risk level, indicators, matches with aliases, sanctions lists with source and validity, PEP positions, RCA links and adverse media |
