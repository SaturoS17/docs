...
| `invalid_payload` | Missing a required field (e.g. `enabled` on AML monitoring, `external_customer_id` on verifications), or the payout QR is unreadable/unsupported (corrupt BR Code or dynamic PIX QR) |
