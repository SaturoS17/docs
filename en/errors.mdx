...
| 403 | `org_suspended` | The organization is not active |
...
| `unknown_org` | Organization slug does not exist |
...
| 503 | `org_credential_missing` | Organization not configured; contact your operator |
