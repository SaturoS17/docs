...
<Warning>
Do not send flat fields like `tax_id`, `registration_number` or
`country_of_incorporation` inside `company` — the screening engine rejects
them with `422`. The identifier goes in
