...
<Steps>
  <Step title="Create the consent link">
  ...
  <Step title="The holder opens the link">
  ...
  <Step title="The holder connects their bank">
  ...
  <Step title="The consent is granted">
...
See the [error catalog](/en/errors) for the full list.
...
<AccordionGroup>
  <Accordion title="Does the holder need a CBPay account?">
  ...
  <Accordion title="What if the holder connects an account owned by someone else?">
  ...
  <Accordion title="Can I revoke a consent after it was granted?">
  ...
  <Accordion title="How long does the link live?">
  ...
  <Accordion title="Is the email mandatory?">
  ...
  <Accordion title="Which countries are covered?">
  ...
  <Accordion title="What data exactly is derived?">
