...
<CardGroup cols={2}>
  ...
  <Card title="Checkout" icon="cart-shopping" href="/en/guides/payins#universal-checkout-link-checkout">
  ...
  <Card title="Cards & subscriptions" icon="credit-card" href="/en/guides/cards">
    ...
    payments, save cards on file and schedule recurring charges.
  </Card>
