...
<CardGroup cols={2}>
  ...
  <Card title="Internal transfers" icon="arrows-left-right" href="/en/guides/transfers">
    Move balance between accounts of the same organization, instantly and
    free of charge.
  </Card>
...
It also ships with integrated **KYC/screening** for persons and companies
([guide](/en/guides/kyc)) and **signed webhooks** for every event
([guide](/en/webhooks)).

## How it works

1. Your operator (the organization) gives you access: email/password
