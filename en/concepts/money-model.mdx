...
your asset through the swap engine — same spread and same limits as a
regular swap.
...
| Spread and limits | The configured swap spread applies, plus the per-operation/24h limits of volatile assets (BTC/GOLD). |
