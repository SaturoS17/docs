...
Fiat operations convert to USDT at the current rate (`GET /v1/rates`, USD
base). Conversion rounds **up** on the debit side, with at most 1 micro-USDT
of difference.
...
| `compliance_fee` / `compliance_refund` | KYC service charge / refund |
