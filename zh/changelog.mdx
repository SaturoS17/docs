...
<Update label="2026年7月24日" description="v2.03">
...
<Update label="2026年7月23日" description="v2.02">
...
<Update label="2026年7月23日" description="v2.01">
...
<Update label="2026年7月23日" description="v2.00">
...
<Update label="2026年7月23日" description="v1.99">
...
<Update label="2026年7月23日" description="v1.98">
...
<Update label="2026年7月23日" description="v1.97">
...
<Update label="2026年7月22日" description="v1.96">
...
<Update label="2026年7月22日" description="v1.95">

**新增**

- **随已保存卡片存档的账单信息**（[payins 指南](/zh/guides/payins#已保存卡片与循环扣款card)）：付款人保存卡片时填写的账单信息（姓名、地址、城市、邮箱、电话）会与凭证一并保存。再次使用该卡支付时，安全页面自动应用这些信息 — 付款人无需重新输入 — 且只显示**脱敏摘要**（姓名、部分邮箱和城市），并提供"使用其他信息"链接以便修改。完整信息绝不下发到浏览器：由服务器在授权时应用。
...
<Update label="2026年7月22日" description="v1.94">

**修复**

- **结账页 — 银行卡一键支付**（[收款指南](/zh/guides/payins#universal-payment-link-checkout)）：在公开页面选择银行卡继续时，现在直接跳转到安全支付页 — 移除了需要二次点击的中间按钮。点击已保存的卡即刻发起支付。
...
<Update label="2026年7月21日" description="v1.93">
